	...
	<div class="profileContainer">
		...
		<div class="profile-left">
			<div class="profile-img-wrap story-border" onclick="popup('.modal-image')">
				...
				<img style="object-fit: cover;" class="profile-image" src="/upload/${dto.user.profileImageUrl }" onerror="this.src='/images/person.jpeg'" id="userProfileImage" />
			</div>
		</div>
		<!--유저이미지end-->
		...
		<div class="profile-right">
			...
			<div class="subscribe">
				<ul>
					...
					<li>
						<a href="javascript:subscribeInfoModalOpenFollower(${dto.user.id });"> 팔로워<span>${dto.followerCount }</span></a>
					</li>
					<li>
						<a href="javascript:subscribeInfoModalOpen(${dto.user.id });"> 팔로우<span>${dto.subscribeCount }</span></a>
					</li>
				</ul>
			</div>
			<div class="state">
	...
	<div class="profileContainer">
		...
		<div id="tab-1-content" class="tab-content-item show">
			...
			<div class="tab-1-content-inner">
				...
				<!-- EL표현식에서 변수를 적으면 자동으로 get함수가 자동으로 호출된다. -->
